...
declare module '@vue/runtime-core' {
  export interface GlobalComponents {
    ...
    SaveOrderForm: (typeof import('./components/SaveOrderForm.vue'))['default'];
    SaveSearchTicketForm: (typeof import('./components/SaveSearchTicketForm.vue'))['default'];
    SaveTicketDescrption: (typeof import('./components/SaveTicketDescrption.vue'))['default'];
    SaveTicketDetail: (typeof import('./components/SaveTicketDetail.vue'))['default'];
