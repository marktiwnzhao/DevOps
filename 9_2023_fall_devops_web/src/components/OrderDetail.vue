  ...
  <div style="display: flex; flex-direction: column">
    ...
    <el-descriptions :column="4" border>
      ...
      <el-descriptions-item
        ...
        width="25%"
        align="center"
        v-if="orderDetail.data && user.privilege == 0"
      >
      ...
      <el-descriptions-item
        ...
        width="25%"
        align="center"
        v-if="orderDetail.data && user.privilege == 2"
      >
        {{ orderDetail.data.raw_money.toFixed(2) }}
      </el-descriptions-item>
      <el-descriptions-item
    ...
    >
      <div style="float: right">
        <el-button type="danger" @click="cancel(id ?? -1)">取消订单</el-button>
        ...
        <el-dialog v-model="selectStrategyFormVisible" title="请选择支付方式">
          <el-form :model="selectStrategyForm">
            <el-form-item label="支付方式" prop="strategy">
              <el-select
                v-model="selectStrategyForm.strategy"
                placeholder="请选择支付方式"
              >
                <el-option
          ...
          <span slot="footer" class="dialog-footer">
            <el-button @click="selectStrategyFormVisible = false">
              取 消
            </el-button>
            <el-button
              type="primary"
              @click="selectPayStrategy(id ?? -1, selectStrategyForm.strategy)"
            >
              确 定
            </el-button>
          </span>
    ...
    >
      <div style="float: right">
        <el-button @click="cancel(id ?? -1)">取消订单</el-button>
      </div>
    </div>
  </div>
</template>
